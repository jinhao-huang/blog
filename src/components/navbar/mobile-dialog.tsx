  ...
  return (
    <DialogTrigger>
      ...
      <Modal className="lg:hidden">
        ...
        <Dialog className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 dark:bg-gray-900 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:sm:ring-white/10">
          {({ close }) => (
            <>
